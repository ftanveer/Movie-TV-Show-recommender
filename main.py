...
try:
    API_KEY = str(os.environ.get("MY_API_KEY"))
    st.write("found!")
except:
...
# length = len(str(API_KEY))
# st.markdown(
#           f"<strong style='color: orange; font-size :24px'> Subscription Cost: </strong><p style='color: orange;'>  {length} </p>",
#           unsafe_allow_html=True,
#       )
